 ...
 * Time: 23:50
 */
public class AdaptPatternMutation extends Mutation {
    private static final Logger LOGGER = LogManager.getLogger(AdaptPatternMutation.class);

    public AdaptPatternMutation(PatternGenerator generator) {
        super(generator);
    }
